...
- [ ] first Download **Admit Card** & Bag setting, then **Visit Exam location** on exact time 7am or 7:30 || or else do breakfast then go. || check Day Buss pass online **{18 September}**  >>  Also some extra pending working like : Print 2 copy Admit Card, Thyrocare area, Neuberg Diagnostics, Kissan Jam, Nippattu2x, Badusha2x, etc.
- [ ] Ready bag for exam day : Water bottle, cap, mobile, 2-Admid cards, id card proof, Sanitizer, Biscuit, Night 2 chappati, etc. 
