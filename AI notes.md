...
Features/Buttons avilable in [ChatGPT](https://chatgpt.com/) tool (without paid or in free version) : 
  ...
  - And inside the chatbox only we can :  
    ...
    - Toggle/Enable '🎙Voice mode' to activate fully voice-based conversation only, in which ChatGPT also talks backs with us. It's actually 'Voice chat' or can say interactive chat. But doesn't keep track or record/history or chat/conversation. So, it just works like any virtual/voice assistant e.g. Google Assistant or Amazon's Alexa or Apple's Siri.  
