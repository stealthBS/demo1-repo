...
Some other non-popular AI tools : Cognition's [Devin AI](https://app.devin.ai/), [Replit](https://replit.com/), [BlackBox AI](https://www.blackbox.ai/), [Mistral - LeChat](https://chat.mistral.ai/chat) (Mixtral model), [Falcon Arabic LLM](https://chat.falconllm.tii.ae/auth), Meta's [LLaMa Chat](https://deepinfra.com/chat), etc.  
