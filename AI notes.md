...
Learning AI course helps to automatically build every other skills little-by-little e.g. coding, language learning, music learning, social media content creation, editing excel/spreadsheet files, etc. Especially to edit online files of **Google Workspace (G Suite)** & **Microsoft Office 365**, for this we need paid subscription of Gemini & Copilot, so then these AI tool will get integrated with those 'office tools' to provide assistance.  
...
Features/Buttons available in [ChatGPT](https://chatgpt.com/) tool (without paid or in free version). Icon's position may varie according to its web-version/desktop-app/mobile-app platforms and also ChatGPT updates it user-interface time-to-time. Basically it have the left-side panel (contain all recent conversations), the model panel on top (contains ChatGPT's different versions), and the prompting window on right-middle : (all the following have their own shortcut keys)  
  ...
  - And inside the chatbox only we can :  
    ...
    - 📤Upload or 📎attach images/files or Markdown's Mermaid-diagrams to ask a corresponding/related queries or to get summary of any large files. [But for **free users** there's a [⚠limited](https://openai.com/chatgpt/pricing/) no. of files to upload only]  
...
#### 🔰Lesson 7 : Generating best prompts through ChatGPT itself [**Attach PDF] 
...
#### 🔰Lesson 8 : Types of Advanced Prompting Frameworks [**Attach PDF]  
...
#### 🔰Lesson 30 : Simple 30 Prompts Starters cheatsheet [**Attach PDF]  
...
#### 🔰Lesson 32 : Practical Everyday Prompts 
...
Prompt Formula : *`I'm looking to explore`* [subject] *`in a`* [format]*`. Do you have any suggestions on`* [topics] *`I can cover?`*   (OR)   *`I'm interested in`* [type of text] *`that highlights the`* [benefits] *`of`* [subject] *`. Please write`* [#] *`for me on`* [subject].
- Example 1 : *`I'm interested in creating an 'Instagram page' that 'covers travel'. What ideas do you have on topics I could include, such as 'budget-friendly destinations' and 'hidden gems to visit?'`*
...
- Example 3 : *`I need an 'email campaign' that showcases the 'features of my new product'. Can you write one for me on the 'ease of use and affordability of the product?'`*
- Example 4 : *`I'm interested in a 'website page' that outlines the 'benefits of my coaching services'. Could you write 'one' for me on the 'personalized approach and proven results of my coaching program?'`*
...
- Example 2 : *`I'm trying to better understand the concept of 'search engine optimization', please help me better understand this concept by creating a practical and easy to understand analogy.`*
